...
"Hallucination" is a catch-all that obscures important differences. In analyzing the cases in the [court decisions involving AI database](/AI-legal-research), five distinct failure modes emerge — and each requires a different corrective.
...
Across the cases in the database, the largest category involves fabricated authority — invented citations that resolved to nothing. This is partly because fabricated citations are the most visible failure: they get caught when opposing counsel or the court checks. The database almost certainly undercounts false quotations and misrepresented holdings, which require more careful reading to identify.
...
*The [court decisions involving AI database](/AI-legal-research) catalogs U.S. court decisions where AI-generated content produced errors in legal proceedings. The [Ethics-Safe AI Use for Law Firms eBook](/ai-ethics-ebook) covers the full verification framework, the five-category taxonomy, and the Model Rules analysis in de