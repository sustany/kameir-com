...
"Hallucination" is a catch-all that obscures important differences. Five distinct failure modes emerge from sanctioned filings — and each requires a different corrective.
...
Across sanctioned cases, the largest category involves fabricated authority — invented citations that resolved to nothing. This is partly because fabricated citations are the most visible failure: they get caught when opposing counsel or the court checks. False quotations and misrepresented holdings, which require more careful reading to identify, are almost certainly undercounted in publicly reported sanctions orders.
...
*The [Ethics-Safe AI Use for Law Firms eBook](/ai-ethics-ebook) covers the full verification framework, the five-category taxonomy, and the Model Rules analysis in detail.*
