...
The [AI Legal Research case library](/AI-legal-research) documents instances of each type across court orders and sanctions proceedings. The pattern across those cases is consistent: the hallucination that caused the problem was not the type the attorney was watching for.
